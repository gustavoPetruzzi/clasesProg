...
$app->get('/verificarToken', function (Request $request, Response $response) {    
    ...
    autentificadorJwt::verificartoken("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE0OTczMTUyMTQsImV4cCI6MTQ5NzMxNTI3NCwiZGF0YSI6eyJub21icmUiOiJKdWFuIiwiYXBlbGxpZG8iOiJQZXJleiIsImVkYWQiOjMzfSwiYXBwIjoiYXBpUmVzdEp3dCJ9.48LFED_x9g__w1_0pSAgh7jE-lHc5MFJ6-P8fL7zlIk");
    return $response;
